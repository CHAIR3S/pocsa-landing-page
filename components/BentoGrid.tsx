...
const productLines: ProductLine[] = [
  {
    ...
    size: "large",
    sampleImages: [
      "/images/office-desks-1.png",
      "/images/office-workspace.png",
      "/images/marble-desk.png",
      "/placeholder.svg?height=450&width=300",
      "/placeholder.svg?height=350&width=400",
      "/placeholder.svg?height=500&width=280",
  ...
  },
  {
    ...
    size: "medium",
    sampleImages: [
      "/images/storage-cabinet.png",
      "/images/office-storage-wall.png",
      "/placeholder.svg?height=400&width=300",
      "/placeholder.svg?height=350&width=400",
      "/placeholder.svg?height=500&width=250",
      "/placeholder.svg?height=300&width=350",
      "/placeholder.svg?height=450&width=300",
      "/placeholder.svg?height=400&width=280",
      "/placeholder.svg?height=350&width=320",
      "/placeholder.svg?height=300&width=300",
    ],
  },
  {
    ...
    sampleImages: [
      ...
      "/placeholder.svg?height=350&width=250",
      "/placeholder.svg?height=400&width=320",
      "/placeholder.svg?height=450&width=280",
      "/placeholder.svg?height=300&width=350",
      "/placeholder.svg?height=400&width=300",
      "/placeholder.svg?height=350&width=320",
  ...
  },
  {
    ...
    sampleImages: [
      ...
      "/placeholder.svg?height=500&width=280",
      "/placeholder.svg?height=300&width=400",
      "/placeholder.svg?height=450&width=250",
      "/placeholder.svg?height=400&width=320",
    ],
  },
];
